---
title: Documentation
description: Welcome to the Boilerplate documentation.
---

This is the documentation for the Boilerplate site.

This is an example of a doc site built using [ContentLayer](/docs/documentation/contentlayer) and MDX.

<Callout>

  This site is a work in progress. If you see dummy text on a page, it means I'm still working on it. You can follow updates on Twitter [@yigityalim](https://twitter.com/yigityalim).
